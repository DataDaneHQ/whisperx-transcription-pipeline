...
This pipeline was originally built to transcribe thousands of sensitive enforcement call recordings across hundreds of customers — locally, offline, and without any audio leaving the team's infrastructure. The full workplace build and the design decisions behind it are documented in the repository [README](../README.md).
